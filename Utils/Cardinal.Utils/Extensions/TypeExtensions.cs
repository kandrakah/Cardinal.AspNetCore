...
namespace Cardinal.Extensions
{
    ...
    public static class TypeExtensions
    {
        ...
        public static bool IsDateTime(this Type clrType)
        {
            var underlyingTypeOrSelf = clrType.GetUnderlyingTypeOrSelf();
        ...
        public static bool IsTimeSpan(this Type clrType)
        {
            var underlyingTypeOrSelf = clrType.GetUnderlyingTypeOrSelf();
        ...
        /// <returns></returns>
        public static bool IsVersion(this Type clrType)
        {
            var underlyingTypeOrSelf = clrType.GetUnderlyingTypeOrSelf();
            return underlyingTypeOrSelf == typeof(CardinalVersion);
        }
